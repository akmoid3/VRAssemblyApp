...
public class InitializedDataManagerTests
{
    ...
    public void Start_InitializesDirectory()
    {
        ...
        Assert.IsTrue(Directory.Exists(testDirectoryPath), "La directory non � stata creata correttamente");
    }
    ...
    public void SaveComponentsData_CreatesJsonFile()
    {
        ...
        Assert.IsTrue(File.Exists(testFilePath), "Il file JSON non � stato creato");

        // Verifica il contenuto del file
        string jsonContent = File.ReadAllText(testFilePath);
        Assert.IsFalse(string.IsNullOrEmpty(jsonContent), "Il contenuto del file JSON � vuoto");
    }
    ...
    public void LoadComponentsData_LoadsDataCorrectly()
    {
        ...
        Assert.AreEqual(ComponentObject.ComponentType.None, componentObject1.GetComponentType(), "Il tipo di componente 1 non � stato caricato correttamente");
        Assert.AreEqual("None", componentObject1.GetGroup(), "Il gruppo del componente 1 non � stato caricato correttamente");
        ...
        string jsonContent = @"
    {
        ...
        Assert.AreEqual(ComponentObject.ComponentType.None, componentObject.GetComponentType(), "Il tipo di componente non � stato impostato correttamente");
        Assert.AreEqual("None", componentObject.GetGroup(), "Il gruppo del componente non � stato impostato correttamente");
